...
```bash
bash .Codex/skills/feishu_sync/sync.sh <SOURCE_MD> <FEISHU_DOC_URL> [NEW_TITLE]
```

**示例：**

```bash
bash .Codex/skills/feishu_sync/sync.sh \
...
```bash
rm -rf .Codex/skills/feishu_sync/cache/*
```
