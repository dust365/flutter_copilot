...
void main() {
  ...
  final mcpPubspecPath = 'packages/flutter_copilot_mcp/pubspec.yaml';
  final flutterPubspecPath = 'packages/flutter_copilot_claw/pubspec.yaml';
  final outputPath = 'packages/flutter_copilot_mcp/lib/src/version.g.dart';
  ...
  print('flutter_copilot_claw version: $flutterVersion');
  ...
  if (mcpVersion != flutterVersion) {
    stderr.writeln(
      ...
      '  flutter_copilot_claw: $flutterVersion\n'
